class User < ApplicationRecord
  ...
  validates :family_name_kanji, format: { with: /\A[一-龯ぁ-んァ-ンー－々ヶ]+\z/, message: "は漢字、カタカナ、ひらがなのみで入力してください" }
  validates :personal_name_kanji, format: { with: /\A[一-龯ぁ-んァ-ンー－々ヶ]+\z/, message: "は漢字、カタカナ、ひらがなのみで入力してください" }
