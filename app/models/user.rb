class User < ApplicationRecord
  ...
  validates :family_name_kanji, format: { with: /\A[ぁ-んァ-ヶ一-龥々ー]+\z/, message: "は漢字、カタカナ、ひらがなのみで入力してください" }
  validates :personal_name_kanji, format: { with: /\A[ぁ-んァ-ヶ一-龥々ー]+\z/, message: "は漢字、カタカナ、ひらがなのみで入力してください" }
